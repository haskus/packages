...
encodeInsn !ctx !op !args = do
  let mode64              = is64bitMode (ctxMode ctx)
      ...
      vex_LIG_66_0F_WIG   = set_vex mkVex_LIG_66_0F_WIG
      ...
      vex_LIG_0F_WIG      = set_vex mkVex_LIG_0F_WIG
      ...
      mr_mem_vec m r = set_r_vec r >> set_m_mem m
  ...
  runE case op of
    ...
    BLSI -> req_bmi1 >> case args of
      [R32 a, R32 b] -> vex_LZ_0F38_W0 0xF3 >> rvm_ext_reg_reg 0x3 a b
      [R32 a, M32 b] -> vex_LZ_0F38_W0 0xF3 >> rvm_ext_reg_mem 0x3 a b
      [R64 a, R64 b] -> vex_LZ_0F38_W1 0xF3 >> rvm_ext_reg_reg 0x3 a b
    ...
    PDEP -> req_bmi2 >> case args of
      [R32 a, R32 b, R32 c] -> vex_LZ_F2_0F38_W0 0xF5 >> rvm_reg_reg_reg a b c
      [R32 a, R32 b, M32 c] -> vex_LZ_F2_0F38_W0 0xF5 >> rvm_reg_reg_mem a b c
      [R64 a, R64 b, R64 c] -> vex_LZ_F2_0F38_W1 0xF5 >> rvm_reg_reg_reg a b c
      [R64 a, R64 b, M64 c] -> vex_LZ_F2_0F38_W1 0xF5 >> rvm_reg_reg_mem a b c
      _ -> invalidArgs

    PEXT -> req_bmi2 >> case args of
      [R32 a, R32 b, R32 c] -> vex_LZ_F3_0F38_W0 0xF5 >> rvm_reg_reg_reg a b c
    ...
    BZHI -> req_bmi2 >> case args of
      [R32 a, R32 b, R32 c] -> vex_LZ_0F38_W0 0xF5 >> rmv_reg_reg_reg a b c
      [R32 a, M32 b, R32 c] -> vex_LZ_0F38_W0 0xF5 >> rmv_reg_mem_reg a b c
      [R64 a, R64 b, R64 c] -> vex_LZ_0F38_W1 0xF5 >> rmv_reg_reg_reg a b c
      [R64 a, M64 b, R64 c] -> vex_LZ_0F38_W1 0xF5 >> rmv_reg_mem_reg a b c
      _ -> invalidArgs
    ...
    MULPD -> req_sse2 >> case args of
      [V128 a, M128 b] -> oc_66_0F 0x59 >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_66_0F 0x59 >> rm_vec_vec a b
      _ -> invalidArgs

    MULPS -> req_sse >> case args of
      [V128 a, M128 b] -> oc_0F 0x59 >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_0F 0x59 >> rm_vec_vec a b
      _ -> invalidArgs

    MULSD -> req_sse2 >> case args of
      [V128 a, M64  b] -> oc_F2_0F 0x59 >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_F2_0F 0x59 >> rm_vec_vec a b
      _ -> invalidArgs

    MULSS -> req_sse >> case args of
      [V128 a, M32  b] -> oc_F3_0F 0x59 >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_F3_0F 0x59 >> rm_vec_vec a b
      _ -> invalidArgs

    DIVPD -> req_sse2 >> case args of
      [V128 a, M128 b] -> oc_66_0F 0x5E >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_66_0F 0x5E >> rm_vec_vec a b
      _ -> invalidArgs

    DIVPS -> req_sse >> case args of
      [V128 a, M128 b] -> oc_0F 0x5E >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_0F 0x5E >> rm_vec_vec a b
      _ -> invalidArgs

    DIVSD -> req_sse2 >> case args of
      [V128 a, M64  b] -> oc_F2_0F 0x5E >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_F2_0F 0x5E >> rm_vec_vec a b
      _ -> invalidArgs

    DIVSS -> req_sse >> case args of
      [V128 a, M32  b] -> oc_F3_0F 0x5E >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_F3_0F 0x5E >> rm_vec_vec a b
      _ -> invalidArgs
    ...
    ANDPD -> req_sse2 >> case args of
      [V128 a, M128 b] -> oc_66_0F 0x54 >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_66_0F 0x54 >> rm_vec_vec a b
      _ -> invalidArgs

    ANDPS -> req_sse >> case args of
      [V128 a, M128 b] -> oc_0F 0x54 >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_0F 0x54 >> rm_vec_vec a b
      _ -> invalidArgs

    ANDNPD -> req_sse2 >> case args of
      [V128 a, M128 b] -> oc_66_0F 0x55 >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_66_0F 0x55 >> rm_vec_vec a b
      _ -> invalidArgs

    ANDNPS -> req_sse >> case args of
      [V128 a, M128 b] -> oc_0F 0x55 >> rm_vec_mem a b
    ...
    MAXPD -> req_sse2 >> case args of
      [V128 a, M128 b] -> oc_66_0F 0x5F >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_66_0F 0x5F >> rm_vec_vec a b
      _ -> invalidArgs

    MAXPS -> req_sse >> case args of
      [V128 a, M128 b] -> oc_0F 0x5F >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_0F 0x5F >> rm_vec_vec a b
      _ -> invalidArgs

    MAXSD -> req_sse2 >> case args of
      [V128 a, M64  b] -> oc_F2_0F 0x5F >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_F2_0F 0x5F >> rm_vec_vec a b
      _ -> invalidArgs

    MAXSS -> req_sse >> case args of
      [V128 a, M32  b] -> oc_F3_0F 0x5F >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_F3_0F 0x5F >> rm_vec_vec a b
      _ -> invalidArgs

    MINPD -> req_sse2 >> case args of
      [V128 a, M128 b] -> oc_66_0F 0x5D >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_66_0F 0x5D >> rm_vec_vec a b
      _ -> invalidArgs

    MINPS -> req_sse >> case args of
      [V128 a, M128 b] -> oc_0F 0x5D >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_0F 0x5D >> rm_vec_vec a b
      _ -> invalidArgs

    MINSD -> req_sse2 >> case args of
      [V128 a, M64  b] -> oc_F2_0F 0x5D >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_F2_0F 0x5D >> rm_vec_vec a b
      _ -> invalidArgs

    MINSS -> req_sse >> case args of
      [V128 a, M32  b] -> oc_F3_0F 0x5D >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_F3_0F 0x5D >> rm_vec_vec a b
      _ -> invalidArgs

    MOVAPD -> req_sse2 >> case args of
      [V128 a, M128 b] -> oc_66_0F 0x28 >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_66_0F 0x28 >> rm_vec_vec a b
      [M128 a, V128 b] -> oc_66_0F 0x29 >> mr_mem_vec a b
      -- redundant
      -- [V128 a, V128 b] -> oc_66_0F 0x29 >> mr_vec_vec a b
      _ -> invalidArgs

    MOVAPS -> req_sse >> case args of
      [V128 a, M128 b] -> oc_0F 0x28 >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_0F 0x28 >> rm_vec_vec a b
      [M128 a, V128 b] -> oc_0F 0x29 >> mr_mem_vec a b
      -- redundant
      -- [V128 a, V128 b] -> oc_0F 0x29 >> mr_vec_vec a b
      _ -> invalidArgs

    MOVUPD -> req_sse2 >> case args of
      [V128 a, M128 b] -> oc_66_0F 0x10 >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_66_0F 0x10 >> rm_vec_vec a b
      [M128 a, V128 b] -> oc_66_0F 0x11 >> mr_mem_vec a b
      -- redundant
      -- [V128 a, V128 b] -> oc_66_0F 0x11 >> mr_vec_vec a b
      _ -> invalidArgs

    MOVUPS -> req_sse >> case args of
      [V128 a, M128 b] -> oc_0F 0x10 >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_0F 0x10 >> rm_vec_vec a b
      [M128 a, V128 b] -> oc_0F 0x11 >> mr_mem_vec a b
      -- redundant
    ...
    RSQRTPS -> req_sse >> case args of
      [V128 a, M128 b] -> oc_0F 0x52 >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_0F 0x52 >> rm_vec_vec a b
      _ -> invalidArgs

    RSQRTSS -> req_sse >> case args of
      [V128 a, M32  b] -> oc_F3_0F 0x52 >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_F3_0F 0x52 >> rm_vec_vec a b
      _ -> invalidArgs

    RCPPS -> req_sse >> case args of
      [V128 a, M128 b] -> oc_0F 0x53 >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_0F 0x53 >> rm_vec_vec a b
      _ -> invalidArgs

    RCPSS -> req_sse >> case args of
      [V128 a, M32  b] -> oc_F3_0F 0x53 >> rm_vec_mem a b
    ...
    UCOMISD -> req_sse2 >> case args of
      [V128 a, M64  b] -> oc_66_0F 0x2E >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_66_0F 0x2E >> rm_vec_vec a b
      _ -> invalidArgs

    UCOMISS -> req_sse >> case args of
      [V128 a, M32  b] -> oc_0F 0x2E >> rm_vec_mem a b
      [V128 a, V128 b] -> oc_0F 0x2E >> rm_vec_vec a b
      _ -> invalidArgs
    ...
    VMULPD -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_128_66_0F_WIG 0x59 >> rvm_vec_vec_vec a b c
      [V256 a, V256 b, V256 c] -> vex_256_66_0F_WIG 0x59 >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M128 c] -> vex_128_66_0F_WIG 0x59 >> rvm_vec_vec_mem a b c
      [V256 a, V256 b, M256 c] -> vex_256_66_0F_WIG 0x59 >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VMULPS -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_128_0F_WIG 0x59 >> rvm_vec_vec_vec a b c
      [V256 a, V256 b, V256 c] -> vex_256_0F_WIG 0x59 >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M128 c] -> vex_128_0F_WIG 0x59 >> rvm_vec_vec_mem a b c
      [V256 a, V256 b, M256 c] -> vex_256_0F_WIG 0x59 >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VMULSD -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_LIG_F2_0F_WIG 0x59 >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M64  c] -> vex_LIG_F2_0F_WIG 0x59 >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VMULSS -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_LIG_F3_0F_WIG 0x59 >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M32  c] -> vex_LIG_F3_0F_WIG 0x59 >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VDIVPD -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_128_66_0F_WIG 0x5E >> rvm_vec_vec_vec a b c
      [V256 a, V256 b, V256 c] -> vex_256_66_0F_WIG 0x5E >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M128 c] -> vex_128_66_0F_WIG 0x5E >> rvm_vec_vec_mem a b c
      [V256 a, V256 b, M256 c] -> vex_256_66_0F_WIG 0x5E >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VDIVPS -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_128_0F_WIG 0x5E >> rvm_vec_vec_vec a b c
      [V256 a, V256 b, V256 c] -> vex_256_0F_WIG 0x5E >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M128 c] -> vex_128_0F_WIG 0x5E >> rvm_vec_vec_mem a b c
      [V256 a, V256 b, M256 c] -> vex_256_0F_WIG 0x5E >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VDIVSD -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_LIG_F2_0F_WIG 0x5E >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M64  c] -> vex_LIG_F2_0F_WIG 0x5E >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VDIVSS -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_LIG_F3_0F_WIG 0x5E >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M32  c] -> vex_LIG_F3_0F_WIG 0x5E >> rvm_vec_vec_mem a b c
      _ -> invalidArgs
    ...
    VANDPD -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_128_66_0F_WIG 0x54 >> rvm_vec_vec_vec a b c
      [V256 a, V256 b, V256 c] -> vex_256_66_0F_WIG 0x54 >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M128 c] -> vex_128_66_0F_WIG 0x54 >> rvm_vec_vec_mem a b c
      [V256 a, V256 b, M256 c] -> vex_256_66_0F_WIG 0x54 >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VANDPS -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_128_0F_WIG 0x54 >> rvm_vec_vec_vec a b c
      [V256 a, V256 b, V256 c] -> vex_256_0F_WIG 0x54 >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M128 c] -> vex_128_0F_WIG 0x54 >> rvm_vec_vec_mem a b c
      [V256 a, V256 b, M256 c] -> vex_256_0F_WIG 0x54 >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VANDNPD -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_128_66_0F_WIG 0x55 >> rvm_vec_vec_vec a b c
      [V256 a, V256 b, V256 c] -> vex_256_66_0F_WIG 0x55 >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M128 c] -> vex_128_66_0F_WIG 0x55 >> rvm_vec_vec_mem a b c
      [V256 a, V256 b, M256 c] -> vex_256_66_0F_WIG 0x55 >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VANDNPS -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_128_0F_WIG 0x55 >> rvm_vec_vec_vec a b c
    ...
    VMAXPD -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_128_66_0F_WIG 0x5F >> rvm_vec_vec_vec a b c
      [V256 a, V256 b, V256 c] -> vex_256_66_0F_WIG 0x5F >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M128 c] -> vex_128_66_0F_WIG 0x5F >> rvm_vec_vec_mem a b c
      [V256 a, V256 b, M256 c] -> vex_256_66_0F_WIG 0x5F >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VMAXPS -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_128_0F_WIG 0x5F >> rvm_vec_vec_vec a b c
      [V256 a, V256 b, V256 c] -> vex_256_0F_WIG 0x5F >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M128 c] -> vex_128_0F_WIG 0x5F >> rvm_vec_vec_mem a b c
      [V256 a, V256 b, M256 c] -> vex_256_0F_WIG 0x5F >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VMAXSD -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_LIG_F2_0F_WIG 0x5F >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M64  c] -> vex_LIG_F2_0F_WIG 0x5F >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VMAXSS -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_LIG_F3_0F_WIG 0x5F >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M32  c] -> vex_LIG_F3_0F_WIG 0x5F >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VMINPD -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_128_66_0F_WIG 0x5D >> rvm_vec_vec_vec a b c
      [V256 a, V256 b, V256 c] -> vex_256_66_0F_WIG 0x5D >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M128 c] -> vex_128_66_0F_WIG 0x5D >> rvm_vec_vec_mem a b c
      [V256 a, V256 b, M256 c] -> vex_256_66_0F_WIG 0x5D >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VMINPS -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_128_0F_WIG 0x5D >> rvm_vec_vec_vec a b c
      [V256 a, V256 b, V256 c] -> vex_256_0F_WIG 0x5D >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M128 c] -> vex_128_0F_WIG 0x5D >> rvm_vec_vec_mem a b c
      [V256 a, V256 b, M256 c] -> vex_256_0F_WIG 0x5D >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VMINSD -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_LIG_F2_0F_WIG 0x5D >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M64  c] -> vex_LIG_F2_0F_WIG 0x5D >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VMINSS -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_LIG_F3_0F_WIG 0x5D >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M32  c] -> vex_LIG_F3_0F_WIG 0x5D >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VMOVAPD -> req_avx >> case args of
      [V128 a, M128 b] -> vex_128_66_0F_WIG 0x28 >> rm_vec_mem a b
      [V128 a, V128 b] -> vex_128_66_0F_WIG 0x28 >> rm_vec_vec a b
      [M128 a, V128 b] -> vex_128_66_0F_WIG 0x29 >> mr_mem_vec a b
      [V256 a, M256 b] -> vex_256_66_0F_WIG 0x28 >> rm_vec_mem a b
      [V256 a, V256 b] -> vex_256_66_0F_WIG 0x28 >> rm_vec_vec a b
      [M256 a, V256 b] -> vex_256_66_0F_WIG 0x29 >> mr_mem_vec a b
      _ -> invalidArgs

    VMOVAPS -> req_avx >> case args of
      [V128 a, M128 b] -> vex_128_0F_WIG 0x28 >> rm_vec_mem a b
      [V128 a, V128 b] -> vex_128_0F_WIG 0x28 >> rm_vec_vec a b
      [M128 a, V128 b] -> vex_128_0F_WIG 0x29 >> mr_mem_vec a b
      [V256 a, M256 b] -> vex_256_0F_WIG 0x28 >> rm_vec_mem a b
      [V256 a, V256 b] -> vex_256_0F_WIG 0x28 >> rm_vec_vec a b
      [M256 a, V256 b] -> vex_256_0F_WIG 0x29 >> mr_mem_vec a b
      _ -> invalidArgs

    VMOVUPD -> req_avx >> case args of
      [V128 a, M128 b] -> vex_128_66_0F_WIG 0x10 >> rm_vec_mem a b
      [V128 a, V128 b] -> vex_128_66_0F_WIG 0x10 >> rm_vec_vec a b
      [M128 a, V128 b] -> vex_128_66_0F_WIG 0x11 >> mr_mem_vec a b
      [V256 a, M256 b] -> vex_256_66_0F_WIG 0x10 >> rm_vec_mem a b
      [V256 a, V256 b] -> vex_256_66_0F_WIG 0x10 >> rm_vec_vec a b
      [M256 a, V256 b] -> vex_256_66_0F_WIG 0x11 >> mr_mem_vec a b
      _ -> invalidArgs

    VMOVUPS -> req_avx >> case args of
      [V128 a, M128 b] -> vex_128_0F_WIG 0x10 >> rm_vec_mem a b
      [V128 a, V128 b] -> vex_128_0F_WIG 0x10 >> rm_vec_vec a b
      [M128 a, V128 b] -> vex_128_0F_WIG 0x11 >> mr_mem_vec a b
    ...
    VRSQRTPS -> req_avx >> case args of
      [V128 a, V128 b] -> vex_128_0F_WIG 0x52 >> rm_vec_vec a b
      [V256 a, V256 b] -> vex_256_0F_WIG 0x52 >> rm_vec_vec a b
      [V128 a, M128 b] -> vex_128_0F_WIG 0x52 >> rm_vec_mem a b
      [V256 a, M256 b] -> vex_256_0F_WIG 0x52 >> rm_vec_mem a b
      _ -> invalidArgs

    VRSQRTSS -> req_avx >> case args of
      [V128 a, V128 b, V128 c] -> vex_LIG_F3_0F_WIG 0x52 >> rvm_vec_vec_vec a b c
      [V128 a, V128 b, M32  c] -> vex_LIG_F3_0F_WIG 0x52 >> rvm_vec_vec_mem a b c
      _ -> invalidArgs

    VRCPPS -> req_avx >> case args of
      [V128 a, V128 b] -> vex_128_0F_WIG 0x53 >> rm_vec_vec a b
      [V256 a, V256 b] -> vex_256_0F_WIG 0x53 >> rm_vec_vec a b
      [V128 a, M128 b] -> vex_128_0F_WIG 0x53 >> rm_vec_mem a b
      [V256 a, M256 b] -> vex_256_0F_WIG 0x53 >> rm_vec_mem a b
      _ -> invalidArgs

    VRCPSS -> req_avx >> case args of
    ...
    VUCOMISD -> req_avx >> case args of
      [V128 a, M64  b] -> vex_LIG_66_0F_WIG 0x2E >> rm_vec_mem a b
      [V128 a, V128 b] -> vex_LIG_66_0F_WIG 0x2E >> rm_vec_vec a b
      _ -> invalidArgs

    VUCOMISS -> req_avx >> case args of
      [V128 a, M32  b] -> vex_LIG_0F_WIG 0x2E >> rm_vec_mem a b
      [V128 a, V128 b] -> vex_LIG_0F_WIG 0x2E >> rm_vec_vec a b
      _ -> invalidArgs
